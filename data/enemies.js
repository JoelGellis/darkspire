    ...
    [
      ...
      },
      {
        ...
        intents: [
          ...
          { name: 'Rally the Dead', type: 'heal_allies', heal: 5, desc: 'HEAL ALL 5' }
        ]
      }
    ],
    ...
    [
      {
        ...
        intents: [
          ...
          { name: 'Mark for Death', type: 'vulnerable', turns: 2, desc: 'VULN 2', targeting: 'front' },
          { name: 'Execute', type: 'attack', dmg: 20, desc: 'ATK 20', targeting: 'front' },
          { name: 'Sharpen', type: 'buff', desc: 'BUFF +3', buffAmt: 3 }
        ]
      }
    ],
    ...
    [
      {
        ...
        intents: [
          ...
          { name: 'Drain', type: 'attack', dmg: 6, desc: 'ATK 6\u2192back', targeting: 'back' }
        ]
      },
      {
