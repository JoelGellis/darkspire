...
(function () {
  ...
  function openTree(selected) {
    ...
    dialog.addEventListener('close', function() { dialog.remove(); DS.UI.render(); if(opener && opener.id) { var next=document.getElementById(opener.id); if(next) next.focus(); } });
