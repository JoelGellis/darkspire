...
## Integrated demo release — 2026-09-10
The progression, positional combat, immediate enemy Block, tolerant save migration/recovery, dismissible update notice, damage/Block breakdown, first-level tutorial, and local bug report are integrated and committed at `95b5bbb` (`95b5bbba131eee9bff74612f8ac85e962c61247f`). The post-commit release build passed all 15 suites and produced version `incremental-8b1e93ea415bf21e`; live Pages deployment rebuilt the same version with publication label `2026-09-10 1546`, save schema 3, and source commit `95b5bbba131eee9bff74612f8ac85e962c61247f`. Browser QA verified the live entrypoint renders the identity gate, release/version label, update notice hook, and bug-report launcher; isolated fixtures verified returning/resume states without normal campaign storage. Canonical URL: https://joelgellis.github.io/darkspire/ .
- 2026-09-10 DESIGN CORRECTION (supersedes five-person expedition): Party size is exactly FOUR permanently. New campaign starts original four heroes and roster capacity FOUR. First completed run grants fifth ROSTER slot as tutorial; later upgrades expand roster only. Preserve existing heroes during migration. Delegated correction and verified same-URL publication to integration lead.

- 2026-09-10 Progression correction landed: exact four campfire party; new roster Fighter/Rogue/Cleric/Wizard with capacity4; first settlement capacity5; five tavern tiers add four roster spaces each, max25; existing excess heroes retained. Progression regressions and persistence-migration pass. Full build still stops on old five-person campfire assertion; integration lead owns remaining renderer/test correction, active-five migration and same-URL HHMM publish. See .agent/PROGRESSION.md; ownership released to Mendel after targeted verification.
- 2026-09-10: User authorized three distinct player-chosen subclasses per base class, with randomized skill options inspired by The Last Spell. No subclass assigned at recruitment; remove starter-kit variant names from hero identity while retaining kit variation. Larger future subclass pool with three rolled choices is deferred. Progression lead assigned; integration/publication pending.

- 2026-09-10 SUBCLASS CORRECTION: recruits are base-class only with randomized starter kits; no birth subclass/variant is displayed. Each class now has three progression subclass paths, selected by the first skill point and locked thereafter; randomized skill nodes remain inside the class/path. Larger recruit rolling pools are explicitly deferred. Local full build passes; same-URL publication pending this checkpoint.

- 2026-09-10 LIVE RELEASE: four-hero/roster correction plus base-class recruit identity and three progression-selected subclass paths are published at https://joelgellis.github.io/darkspire/ as incremental-c1669fcf84a18cb1, label 2026-09-10 1820, source e61e8d0, save schema 3. Live manifest and headless browser DOM verified; deployment 34513682807 succeeded. Larger recruit rolling pools remain planned/deferred.

- 2026-09-10 FINAL SUBCLASS PASS:24 fixed progression-selected subclasses implemented; recruits retain base-only identity and varied kits. Five tiers use distinct existing actions, themed saved utility rolls and real technique masteries. Schema3 preserves compatible legacy effects and refunds old points once without choosing subclass. All12 release suites pass including72 real technique plays; native Chrome isolated fixture passes desktop and390px, choice/persistence/keyboard focus verified. Final local artifact e9ee051fe2a5ca4d pending Mendel same-URL publication; no independent publish. Full handoff .agent/PROGRESSION.md and docs/SUBCLASSES.md.

- 2026-09-10 FINAL LIVE VERIFICATION: Heisenberg final subclass/mastery/migration/UI source is published at https://joelgellis.github.io/darkspire/ as incremental-e9ee051fe2a5ca4d, publication label 2026-09-10 1911, save schema 3, source d185fbe3891e22c5ecf4ecfc18534e1f9255213f. Workflow 34518833337 succeeded. All 12 release suites and native Chrome desktop/390px fixture checks pass. Live manifest and headless DOM verified four-hero copy, skill runtime, migration hook, bug-report launcher, version label, and no runtime errors. Larger recruit rolling pools remain deferred.
